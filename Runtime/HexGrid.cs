...
public class HexGrid : MonoBehaviourSingleton<HexGrid>
{
	...
	[SerializeField] private HexGridPathfinder _hexGridPathfinder;
	public HexGridPathfinder _HexGridPathfinder => this._hexGridPathfinder;

	public Vector3[] CalculatePath(Vector3 start, Vector3 end) => this._hexGridPathfinder.CalculatePath(start: start, end: end, grid: this);
}